...
var boatAnimation = [];
// boatspritedata it actually contains data from jason;
...
function setup() {
  ...
  for (var i = 0; i < boatFrames.length; i++) {
    // in var pos we are gettin position of each frame from boasty frames
    // in var img we get the image the image from the boatspritesheet which matches the position we got in pos variable
    //in ,ine 40 we are pushing the aninmaiton to the array;
